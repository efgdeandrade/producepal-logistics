    ...
    <div className="min-h-screen bg-background flex flex-col">
      <div className="portal-header">
        <div className="flex items-center gap-2 pt-1">
          ...
          <div>
            <h1 className="text-xl font-semibold leading-tight">Marketing</h1>
            <p className="text-xs text-muted-foreground">Customer segments, product trends, and outreach</p>
          </div>
        </div>
      </div>
