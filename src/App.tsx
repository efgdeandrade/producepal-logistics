        ...
        <AuthProvider>
          ...
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/fnb/picker/:orderId?" element={<ProtectedRoute><PasswordChangeRequired><FnbPicker /></PasswordChangeRequired></ProtectedRoute>} />
              ...
              <Route path="/fnb/driver-zones" element={<ProtectedRoute><PasswordChangeRequired><FnbDriverZones /></PasswordChangeRequired></ProtectedRoute>} />
