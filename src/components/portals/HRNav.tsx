...
const navItems = [
  ...
  { path: '/hr/employees', label: 'Team', icon: Users },
  { path: '/hr/attendance', label: 'Clock', icon: Clock },
  { path: '/hr/documents', label: 'Docs', icon: FileText },
  { path: '/hr/timesheets', label: 'Sheets', icon: Settings },
];
